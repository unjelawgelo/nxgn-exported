...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[100] flex max-h-screen flex-col-reverse p-3 sm:bottom-4 sm:right-4 sm:top-auto sm:flex-col md:max-w-[420px] w-auto",
      className
    )}
    {...props}
  />
